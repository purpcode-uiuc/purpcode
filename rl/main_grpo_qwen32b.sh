...
MODEL_PATH="outputs/purpcode-32b-ctxdistill-0622"
...
PPO_MAX_TOKEN_LEN_PER_GPU=$(( 5 * $(( $MAX_PROMPT_LEN + $MAX_RESPONSE_LEN )) ))
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=${DATASET}-32b \
    trainer.nnodes=1 \
    trainer.default_local_dir=./models/purpcode-32b-rl-${DATASET} \
