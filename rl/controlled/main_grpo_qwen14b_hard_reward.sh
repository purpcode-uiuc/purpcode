...
export SOFT_CODESEC_REWARD=0.0 # hard 0-1 reward
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=${DATASET}-hard-reward \
    trainer.nnodes=1 \
    trainer.default_local_dir=./models/purpcode-rl-${DATASET}-14b-hard-reward \
